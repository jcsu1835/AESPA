...
## Heat Map
AESPA can draw the heat map of a plot variable on the nodal diagram generated by AESPA. For example, the t_liq heat map is generated with above the system model. It is shown as follows:
